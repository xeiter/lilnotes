 ...
 */
$xeiter_core_directory = '../xeiter-core/';

$xc_includes = [
	$xeiter_core_directory . 'config.php', // Configuration
	$xeiter_core_directory . 'ia.php', // Information architecture definitions
	$xeiter_core_directory . 'theme_support.php', // Theme support
	$xeiter_core_directory . 'walkers/wp-bootstrap-4-nav-walker.php', // Navigation walker
];

foreach ($xc_includes as $file) {
